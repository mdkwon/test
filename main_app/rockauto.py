...
def rockauto(part_input_query, make_query, year_query, model_query):
    ...
    driver_autozone = webdriver.Chrome("/chromedriver/chromedriver", chrome_options=chrome_options)
    driver_ebay = webdriver.Chrome("/chromedriver/chromedriver", chrome_options=chrome_options)
    driver_partsgeek = webdriver.Chrome("/chromedriver/chromedriver", chrome_options=chrome_options)
    driver_google_shopping = webdriver.Chrome("/chromedriver/chromedriver", chrome_options=chrome_options)
